<properties linkid="develop-mobile-how-to-guides-multiple-clients-single-service" writer="krisragh" urldisplayname="Multiple Clients" pageTitle="Target multiple clients from a single mobile service | Mobile Services Tutorials" title="Target multiple clients from a single mobile service | Mobile Services Tutorials" metakeywords="mobile services, multiple clients" description="Learn how to use a single mobile service back-end from multiple client apps that target different mobile platforms, including Windows Store and Windows Phone." umbraconavihide="0" disquscomments="1"></properties>
