<properties linkid="develop-net-how-to-guides-service-bus-amqp-overview" urlDisplayName="Service Bus AMQP Overview" pageTitle="Service Bus AMQP overview - Windows Azure " Title="Service Bus AMQP overview - Windows Azure " metaKeywords="" Description="Learn about using the Advanced Message Queuing Protocol (AMQP) 1.0 in Windows Azure." metaCanonical="" disqusComments="1" umbracoNaviHide="1" />
