...
<h2>Next Steps</h2>
So far we have covered delivering media by downloading from Windows Azure Storage and using Smooth Streaming. The next topic [How to Deliver HLS content](http://go.microsoft.com/fwlink/?LinkId=301817) discusses delivering streaming content using Apple HTTP Live Streaming (HLS).