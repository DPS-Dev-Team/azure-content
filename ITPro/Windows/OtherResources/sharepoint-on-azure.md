...
<p>![](../media/azure-sharepoint-wp-1.png)</p>
...
<p>![](../media/azure-sharepoint-wp-2.png)</p>
...
<p>![](../media/azure-sharepoint-wp-3.png)</p>
...
<li>Create a VM with base operating system: On the Windows Azure Management Portal, click <strong>+NEW</strong>, then click <strong>VIRTUAL MACHINE</strong>, and then click <strong>FROM GALLERY</strong>. ![](../media/azure-sharepoint-wp-4.png)</li>

<li>The <strong>VM OS Selection</strong> dialog box appears. Click <strong>Platform Images</strong>, select the <strong>Windows Server 2008 R2 SP1</strong> platform image. ![](../media/azure-sharepoint-wp-5.png)</li>
...
![](../media/azure-sharepoint-wp-6.png)</li>
...
![](../media/azure-sharepoint-wp-7.png)</li>
...
![](../media/azure-sharepoint-wp-10.png)</li>
...
<p>![](../media/azure-sharepoint-wp-11.png)</p>
...
<p>![](../media/azure-sharepoint-wp-12.png)</p>
...
<p>![](../media/azure-sharepoint-wp-13.png)</p>
...
<p>![](../media/azure-sharepoint-wp-14.png)</p>
